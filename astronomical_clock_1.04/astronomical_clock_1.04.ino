...
#define MYSSID "YOURNETWORKNAME"
#define MYPASSKEY "NETWORKPASSWORD"

// pick timezone from TZ.h (https://github.com/esp8266/Arduino/blob/master/cores/esp8266/TZ.h)
#define TIMEZONE "CET-1CEST,M3.5.0,M10.5.0/3"

#define LONGITUDE 6.57
#define LATTITUDE 53.22
...
void setup() {
   ...
   Serial.println("    Astronomical Clock");
   Serial.println("     By illusionmanager");
